...
File: Single Value Strcuture.py 
"""
...
def main():
	...
	for i in range(max_iter):
		...
		t1 = Thread(target=lambda q, arg1, arg2: q.put(l_reg.train_ogd(arg1, arg2)), args=(q1, 0.01, idx))
		t2 = Thread(target=lambda q, arg1, arg2: q.put(ftrl_reg.train_ogd(arg1, arg2)), args=(q2, 3, idx))
		t3 = Thread(target=lambda q, arg1, arg2, arg3: q.put(pclr_reg.train_ogd(arg1, arg2, arg3)), args=(q3, 0.01, 1.0, idx))
		t4 = Thread(target=lambda q, arg1, arg2, arg3: q.put(pi_reg.train_ogd(arg1, arg2, arg3)), args=(q4, 0.01, 40, idx))
		t1.start()
		t2.start()
		t3.start()
		t4.start()
